  ...
  try {
    ...
    await MenuItem.bulkCreate([
      ...
      },
      {
        ...
        isAvailable: true,
        allergens: ['dairy'],
        imageUrl: 'https://images.unsplash.com/photo-1592417817098-8fd3d9eb14a5?w=800&q=80'
      },
      ...
      },
      {
        ...
        description: 'Whole lobster with creamy cognac sauce',
        category: 'main',
        price: 52.99,
        isAvailable: true,
      ...
      },
      {
        ...
        isAvailable: true,
        allergens: ['dairy', 'gluten'],
        imageUrl: 'https://images.unsplash.com/photo-1637806930600-37fa8892069d?w=800&q=80'
      },
      {
        name: 'Filet Mignon',
        description: '8oz tender beef filet with béarnaise sauce',
        category: 'main',
        price: 46.99,
        isAvailable: true,
      ...
      },
      {
        ...
        description: 'Asian vegetables with tofu in ginger soy sauce',
        category: 'main',
        price: 19.99,
        isAvailable: true,
        allergens: ['soy'],
      ...
      },
      {
        ...
        description: 'Herb-crusted pork with apple chutney',
        category: 'main',
        price: 29.99,
        isAvailable: true,
        allergens: ['gluten'],
        imageUrl: 'https://images.unsplash.com/photo-1602470520998-f4a52199a3d6?w=800&q=80'
      },
      ...
      {
        name: 'Apple Tart',
        description: 'Homemade apple tart with vanilla ice cream',
        category: 'dessert',
        price: 11.99,
        isAvailable: true,
        allergens: ['dairy', 'gluten', 'eggs'],
      ...
      {
        name: 'Tasting Menu',
        description: '5-course tasting menu selected by the chef',
        category: 'special',
        price: 89.99,
        isAvailable: true,
        allergens: [],
